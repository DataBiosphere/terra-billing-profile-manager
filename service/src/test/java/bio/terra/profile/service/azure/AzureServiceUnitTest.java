...
class AzureServiceUnitTest extends BaseUnitTest {
  ...
  void getManagedApps() {
    ...
    var azureService =
        new AzureService(
            crlService,
            new AzureConfiguration("fake", "fake", "fake", false, ".default", offers, ImmutableSet.of()),
            profileDao);
  ...
  void getServiceCatalogManagedApps() {
    ...
    var azureService =
        new AzureService(
            crlService,
            new AzureConfiguration("fake", "fake", "fake", true, ".default", offers, ImmutableSet.of()),
            profileDao);
    ...
    var azureService =
        new AzureService(
            ...
            new AzureConfiguration(
                "fake", "fake", "fake", false, ".default", ImmutableSet.of(), ImmutableSet.of()),
